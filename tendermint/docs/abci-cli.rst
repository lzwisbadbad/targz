...
Its code can be found `here <https://github.com/bcbchain/tendermint/abci/blob/master/cmd/abci-cli/abci-cli.go>`__ and looks like:
...
Golang <https://github.com/bcbchain/tendermint/abci/tree/master/server>`__. See
...
Like the kvstore app, its code can be found `here <https://github.com/bcbchain/tendermint/abci/blob/master/cmd/abci-cli/abci-cli.go>`__ and looks like:
...
`example directory <https://github.com/bcbchain/tendermint/abci/tree/master/example`__).
