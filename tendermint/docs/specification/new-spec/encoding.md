...
specification](https://github.com/bcbchain/tendermint/go-amino#amino-encoding-for-go) for
more details.
...
spec](https://github.com/bcbchain/tendermint/go-amino#computing-the-prefix-and-disambiguation-bytes).
