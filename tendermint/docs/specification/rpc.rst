...
library <https://github.com/bcbchain/tendermint/tree/master/rpc/lib>`__.
...
`responses.go <https://github.com/bcbchain/tendermint/blob/master/rpc/core/types/responses.go>`__
