...
A
`Block <https://godoc.org/github.com/bcbchain/tendermint/types#Block>`__
contains:

-  a `Header <#header>`__ contains merkle hashes for various chain
   states
-  the
   `Data <https://godoc.org/github.com/bcbchain/tendermint/types#Data>`__
...
The
`Header <https://godoc.org/github.com/bcbchain/tendermint/types#Header>`__
...
`Validators <https://godoc.org/github.com/bcbchain/tendermint/types#Validator>`__.
...
validators <https://godoc.org/github.com/bcbchain/tendermint/types#ValidatorSet.Hash>`__
to see if there have been changes.

The ``AppHash`` serves as the basis for validating any merkle proofs
that come from the `ABCI
application <https://github.com/bcbchain/tendermint/abci>`__. It represents the
...
The
`Commit <https://godoc.org/github.com/bcbchain/tendermint/types#Commit>`__
contains a set of
`Votes <https://godoc.org/github.com/bcbchain/tendermint/types#Vote>`__
...
`light-client <https://github.com/bcbchain/tendermint/light-client>`__ package.
...
bytes <https://godoc.org/github.com/bcbchain/tendermint/types#Vote.WriteSignBytes>`__
using the chainID and a `nice helper
function <https://godoc.org/github.com/bcbchain/tendermint/types#SignBytes>`__,
...
The `block
hash <https://godoc.org/github.com/bcbchain/tendermint/types#Block.Hash>`__
...
`ABCI <https://github.com/bcbchain/tendermint/abci>`__ application to accept or
reject transactions.
...
`BlockID <https://godoc.org/github.com/bcbchain/tendermint/types#BlockID>`__,
...
The
`PartSetHeader <https://godoc.org/github.com/bcbchain/tendermint/types#PartSetHeader>`__
contains the total number of pieces in a
`PartSet <https://godoc.org/github.com/bcbchain/tendermint/types#PartSet>`__,
