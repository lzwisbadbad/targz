...
- ``abci-client`` As mentioned in `Application Development Guide
  ...
  <https://github.com/bcbchain/tendermint/abci/tree/master/client>`__.
...
- ``events``
  ...
  `here
  <https://github.com/bcbchain/tendermint/blob/master/types/events.go>`__.
...
- ``p2p``
  ...
  <https://github.com/bcbchain/tendermint/blob/56c60fba2381e4ac41d2ae38a1eb6569acfbc095/p2p/README.md>`__.

- ``rpc``
  `Tendermint's RPC <specification/rpc.html>`__.

- ``rpc-server``
  RPC server. For implementation details, please read the `README <https://github.com/bcbchain/tendermint/blob/master/rpc/lib/README.md>`__.
