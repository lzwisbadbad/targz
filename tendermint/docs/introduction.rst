...
using Tendermint consensus. Indeed, `we did that with Ethereum <https://github.com/bcbchain/tendermint/ethermint>`__.
...
The `Application BlockChain Interface (ABCI) <https://github.com/bcbchain/tendermint/abci>`__ allows for Byzantine Fault Tolerant replication of applications written in any programming language.
...
`Tendermint Core <https://github.com/bcbchain/tendermint>`__ (the "consensus engine") communicates with the application via a socket protocol that
satisfies the `ABCI <https://github.com/bcbchain/tendermint/abci>`__.
...
The messages are specified here: `ABCI Message Types <https://github.com/bcbchain/tendermint/abci#message-types>`__.
