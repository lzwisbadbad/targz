...
import (
	...
	"github.com/bcbchain/tendermint/rpc/client"
...
func (c Client) ABCIQueryEx(path string) (*ctypes.ResultABCIQueryEx, error) {
	return c.ABCIQueryExWithOptions(path)
}

func (c Client) ABCIQueryExWithOptions(path string) (*ctypes.ResultABCIQueryEx, error) {
