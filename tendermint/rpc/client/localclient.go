...
import (
	...
	"github.com/bcbchain/tendermint/rpc/core"
...
func (c *Local) ABCIQueryEx(path string) (*ctypes.ResultABCIQueryEx, error) {
	return c.ABCIQueryExWithOptions(path)
}

func (Local) ABCIQueryExWithOptions(path string) (*ctypes.ResultABCIQueryEx, error) {
	return core.ABCIQueryEx(path)
}
