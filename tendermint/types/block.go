...
type Header struct {
	...
	// version of proposer's tendermint - added 14 Dec. 2018
	...
	// version of block
	BlockVersion *string `json:"block_version,omitempty"` // todo 这个字段有问题 并且sdk和中继要加这个字段 区块版本常量？？
}
...
func (h *Header) Hash() cmn.HexBytes {
	...
	if h.BlockVersion != nil {
		mapForHash["BlockVersion"] = aminoHasher(h.BlockVersion)
	}
